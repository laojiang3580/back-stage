...
<script setup>
      import _cityData from './citydata.js'
      import instance from '../../service/request.js'
      import {ref, reactive, onBeforeMount} from 'vue'
      import { ElMessage } from 'element-plus'
      import ElTimeline from '../../plugins/timeline/src/main.vue'
      ...
      const cityData = reactive(_cityData)
      ...
      const getOrderList = async () => {
        const { data: res } = await instance.get('orders', {
          params: queryInfo
        })
      ...
      const showProgressBox = async () => {
        const { data: res } = await instance.get('/kuaidi/804909574412544580')
